...
1) Run `./gradlew :navigation3-browser:publishToMavenLocal`
2) Open `~/.m2/repository/com/github/terrakok/navigation3/browser/`
...
2) Add developer id, name, email and the project url to  
   `./navigation3-browser/build.gradle.kts`
...
4) Add these lines to `gradle.properties`:
   ...
   ```
5) Run `./gradlew :navigation3-browser:publishAndReleaseToMavenCentral --no-configuration-cache`
